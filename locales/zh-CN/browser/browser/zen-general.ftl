...
tab-context-zen-add-essential = 
    ...
    .accesskey = E
tab-context-zen-add-essential-badge = 填充了 { $num } / { $max } 个槽
...
zen-copy-current-url-confirmation = 已复制当前 URL!
...
zen-icons-picker-svg = 
    .label = 图标集
urlbar-search-mode-zen_actions = 动作
zen-site-data-settings = 设置
zen-generic-manage = 管理
zen-generic-more = 更多
zen-generic-next = 下一步
# These labels will be used for the site data panel settings
zen-site-data-setting-allow = 已允许
zen-site-data-setting-block = 已拦截
zen-site-data-protections-enabled = 已启用
zen-site-data-protections-disabled = 已禁用
...
zen-site-data-panel-feature-callout-title = 用于附加组件、权限等的新主页
zen-site-data-panel-feature-callout-subtitle = 点击该图标管理站点设置，查看安全信息，访问扩展并执行常见动作。
...
zen-sidebar-notification-updated-label = { -brand-short-name } 中新功能
zen-sidebar-notification-updated-tooltip = 
    .title = 查看发行说明
zen-sidebar-notification-restart-safe-mode-label = 出了点问题?
