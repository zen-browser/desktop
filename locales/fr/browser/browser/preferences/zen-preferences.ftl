...
zen-standalone-window-header = Fenêtres autonomes
zen-standalone-window-description = Contrôlez la manière dont les liens ouverts depuis l’extérieur de Zen sont gérés.
zen-standalone-window-enabled =
    .label = Ouvrir les liens externes dans des fenêtres autonomes
