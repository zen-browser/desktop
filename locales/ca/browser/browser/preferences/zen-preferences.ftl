...
zen-standalone-window-header = Finestres independents
zen-standalone-window-description = Controla com es gestionen els enllaços oberts fora del Zen.
zen-standalone-window-enabled =
    .label = Obre els enllaços externs en finestres independents
