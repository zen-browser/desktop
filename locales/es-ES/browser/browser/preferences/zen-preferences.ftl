...
zen-settings-workspaces-sync = 
    .label = Sincronice su barra lateral entre dispositivos
    .description = Mantenga sincronizados sus espacios de trabajo, pestañas fijadas y carpetas en todos sus dispositivos mediante su cuenta de Mozilla.
