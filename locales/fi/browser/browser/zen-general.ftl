...
tab-context-zen-edit-pinned-page = 
    .label =
        { $isEssential ->
            [true] Muokkaa Essential URL
           *[false] Muokkaa Pinned URL
        }
    .accesskey = P
tab-context-zen-replace-pinned-url-with-current = 
    .label = Korvaa nykyisellä URL-osoitteella
    .accesskey = C
...
zen-copy-current-url-as-markdown-confirmation = Kopioitu nykyinen URL-osoite Markdown!
zen-general-cancel-label = 
    .label = Peruuta
zen-general-confirm = 
    .label = Vahvista
zen-pinned-tab-replaced = Pinned tab URL has been replaced with the current URL.
zen-pinned-tab-url-edited = Kiinnitetty välilehti URL on päivitetty!
zen-pinned-tab-url-invalid = Se ei näytä kelvolliselta URL:ltä.
zen-pinned-tab-edit-url-title = Muokkaa Kiinnitettyä URL-osoitetta
zen-pinned-tab-edit-url-label = Syötä URL-osoite tähän kiinnitettyyn välilehteen pisteeseen:
...
zen-split-view-limit-toast = Uusia paneeleja ei voi lisätä jaetun näkymään!
...
zen-essentials-promo-label = Lisää Essentialsiin
zen-essentials-promo-sublabel = Pidä suosikki välilehdet vain napsauta pois
...
zen-window-sync-migration-dialog-title = Pidä Windows synkronoituna
...
zen-window-sync-migration-dialog-learn-more = Lue Lisää
zen-window-sync-migration-dialog-accept = Asia Asia
