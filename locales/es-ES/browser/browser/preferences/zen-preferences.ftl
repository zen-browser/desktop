...
zen-urlbar-title = Barra de direcciones de Astra
...
category-zen-marketplace = 
    .tooltiptext = Modificaciones de Astra
...
zenCKSOption-group-zen-other = Otras características de Astra
...
zen-toggle-sidebar-shortcut = Alternar barra lateral de Astra
