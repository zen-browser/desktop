...
zen-standalone-window-header = Samodzielne okna
zen-standalone-window-description = Określ, jak obsługiwane są linki otwierane poza Zen.
zen-standalone-window-enabled =
    .label = Otwieraj zewnętrzne linki w samodzielnych oknach
