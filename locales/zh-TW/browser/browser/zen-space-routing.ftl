...
zen-space-routing-settings = 
    .label = 網址導向設定
zen-space-routing-rulepanel-placeholder = 讓您能決定要將特定網站開啟在 Zen 的特定工作區。舉例來說，您可以設定將YouTube連結一律開啟在Personal工作區內。
...
zen-space-routing-tab-routed-toast = 已於 { $targetWorkspace }工作區開啟分頁
