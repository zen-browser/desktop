...
zen-theme-marketplace-header = Astra 모드
...
zen-theme-marketplace-input-default-placeholder = 
    .placeholder = 입력...
pane-zen-marketplace-title = Astra 모드
...
zenCKSOption-group-zen-other = 다른 Astra 기능들
...
zen-toggle-sidebar-shortcut = Astra 사이드바 켜기/끄기
