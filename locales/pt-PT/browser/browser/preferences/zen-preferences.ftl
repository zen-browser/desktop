...
sync-currently-syncing-workspaces = Espaços de Trabalho e Separadores
sync-engine-workspaces =
    .label = Espaços de Trabalho e Separadores
    .tooltiptext = Sincronize os seus espaços de trabalho e separadores entre dispositivos
    .accesskey = W
