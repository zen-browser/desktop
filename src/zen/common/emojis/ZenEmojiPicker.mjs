...
// file, You can obtain one at http://mozilla.org/MPL/2.0/.
{
  // prettier-ignore
  const SVG_ICONS = [
    "airplane.svg", "american-football.svg", "bandage.svg", "baseball.svg", 
    "basketball.svg", "basket.svg", "bed.svg", "bell.svg", 
    "bonfire.svg", "bookmark.svg", "book.svg", "briefcase.svg", 
    "brush.svg", "bug.svg", "build.svg", "cafe.svg", 
    "calendar-number.svg", "call.svg", "card.svg", "car.svg", 
    "chat.svg", "checkbox.svg", "circle.svg", "cloud.svg", 
    "code.svg", "coins.svg", "construct.svg", "cutlery.svg", 
    "diamond.svg", "egg.svg", "extension-puzzle.svg", "eye.svg", 
    "fast-food.svg", "fish.svg", "flag.svg", "flame.svg", 
    "flask.svg", "folder.svg", "football.svg", "game-controller.svg", 
    ...
    "lightning.svg", "location.svg", "lock-closed.svg", "logo-android.svg", 
    "logo-apple.svg", "logo-github.svg", "logo-google.svg", "logo-markdown.svg", 
    "logo-rss.svg", "logo-twitter.svg", "logo-usd.svg", "logo-youtube.svg", 
    "mail.svg", "map.svg", "megaphone.svg", "moon.svg", 
    "music.svg", "navigate.svg", "nuclear.svg", "page.svg", 
    "palette.svg", "paw.svg", "people.svg", "pizza.svg", 
    "planet.svg", "present.svg", "pricetag.svg", "receipt.svg", 
    "rocket.svg", "school.svg", "shapes.svg", "shirt.svg", 
    "skull.svg", "squares.svg", "square.svg", "star-1.svg", 
    "star.svg", "stats-chart.svg", "sun.svg", "tada.svg", 
    "telescope.svg", "terminal.svg", "thumbs-up.svg", "ticket.svg", 
    "time.svg", "train.svg", "trash.svg", "triangle.svg", 
    "umbrella.svg", "video.svg", "volume-high.svg", "wallet.svg", 
    "warning.svg", "water.svg", "weight.svg", 
  ];
