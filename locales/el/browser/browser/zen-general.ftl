...
tab-context-zen-replace-pinned-url-with-current = 
    .label = Αντικατάσταση με τρέχουσα διεύθυνση URL
    .accesskey = C
...
zen-pinned-tab-url-edited = Η καρφιτσωμένη καρτέλα URL έχει ενημερωθεί!
zen-pinned-tab-url-invalid = Αυτό δεν μοιάζει με ένα έγκυρο URL.
zen-pinned-tab-edit-url-title = Επεξεργασία Καρφιτσωμένου URL
zen-pinned-tab-edit-url-label = Εισάγετε το URL που αυτή η καρφιτσωμένη καρτέλα πρέπει να δείχνει στο:
...
zen-split-view-limit-toast = Δεν είναι δυνατή η προσθήκη περισσότερων πινάκων στη χωρισμένη προβολή!
