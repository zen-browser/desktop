...
zen-standalone-window-header = Ffenestri annibynnol
zen-standalone-window-description = Rheoli sut mae dolenni a agorir o’r tu allan i Zen yn cael eu trin.
zen-standalone-window-enabled =
    .label = Agor dolenni allanol mewn ffenestri annibynnol
