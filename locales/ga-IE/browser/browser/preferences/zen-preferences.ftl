...
zen-standalone-window-header = Fuinneoga neamhspleácha
zen-standalone-window-description = Rialaigh an chaoi a láimhseáiltear naisc a osclaítear lasmuigh de Zen.
zen-standalone-window-enabled =
    .label = Oscail naisc sheachtracha i bhfuinneoga neamhspleácha
