...
zen-standalone-window-header = Zelfstandige vensters
zen-standalone-window-description = Bepaal hoe koppelingen die buiten Zen worden geopend, worden verwerkt.
zen-standalone-window-enabled =
    .label = Externe koppelingen in zelfstandige vensters openen
