...
zen-standalone-window-header = Окремі вікна
zen-standalone-window-description = Керуйте способом обробки посилань, відкритих за межами Zen.
zen-standalone-window-enabled =
    .label = Відкривати зовнішні посилання в окремих вікнах
