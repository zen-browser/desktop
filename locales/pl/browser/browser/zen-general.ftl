...
zen-pinned-tab-url-edited = URL przypiętej karty został zaktualizowany!
zen-pinned-tab-url-invalid = To nie wygląda jak poprawny adres URL.
zen-pinned-tab-edit-url-title = Edytuj przypięty adres URL
zen-pinned-tab-edit-url-label = Wprowadź adres URL przypiętej karty powinien wskazywać na:
