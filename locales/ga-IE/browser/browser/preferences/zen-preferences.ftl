...
zen-settings-workspaces-sync = 
    .label = Sioncrónaigh do bharra taoibh ar fud gléasanna
    .description = Coinnigh do spásanna oibre, do chluaisíní bioráilte agus do fhillteáin sioncrónaithe ar do ghléasanna go léir trí do chuntas Mozilla.
