...
zen-settings-workspaces-sync = 
    .label = Synkronisera ditt sidofält mellan enheter
    .description = Behåll dina arbetsytor, flikar och mappar synkroniserade på alla dina enheter via ditt Mozilla-konto.
