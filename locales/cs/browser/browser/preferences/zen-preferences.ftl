...
sync-currently-syncing-workspaces = Pracovní prostory a panely
sync-engine-workspaces =
    .label = Pracovní prostory a panely
    .tooltiptext = Synchronizujte pracovní prostory a panely napříč zařízeními
    .accesskey = W
