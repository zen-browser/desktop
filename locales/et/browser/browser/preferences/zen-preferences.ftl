...
zen-standalone-window-header = Eraldiseisvad aknad
zen-standalone-window-description = Määra, kuidas väljaspool Zeni avatud linke käsitletakse.
zen-standalone-window-enabled =
    .label = Ava välised lingid eraldiseisvates akendes
