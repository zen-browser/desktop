...
sync-currently-syncing-workspaces = Työtilat ja välilehdet
sync-engine-workspaces =
    .label = Työtilat ja välilehdet
    .tooltiptext = Synkronoi työtilat ja välilehdet eri laitteiden välillä
    .accesskey = W
