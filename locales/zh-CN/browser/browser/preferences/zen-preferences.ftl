...
zen-theme-marketplace-header = Astra 模组
...
zen-theme-marketplace-input-default-placeholder = 
    .placeholder = 输入点什么…
pane-zen-marketplace-title = Astra 模组
...
zenCKSOption-group-zen-other = Astra 的其它功能
...
zen-toggle-sidebar-shortcut = 切换 Astra 侧边栏
