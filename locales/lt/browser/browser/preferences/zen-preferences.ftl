...
sync-currently-syncing-workspaces = Darbo sritys ir kortelės
sync-engine-workspaces =
    .label = Darbo sritys ir kortelės
    .tooltiptext = Sinchronizuokite savo darbo sritis ir korteles tarp įrenginių
    .accesskey = W
