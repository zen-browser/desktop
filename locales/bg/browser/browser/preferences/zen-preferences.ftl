...
zen-theme-marketplace-close-modal = Затвори
...
zenCKSOption-group-zen-compact-mode = Компактен изглед
zenCKSOption-group-zen-workspace = Workspaces
zenCKSOption-group-zen-other = Other Zen Features
zenCKSOption-group-zen-split-view = Разделен изглед
...
zen-bookmark-this-page-shortcut = Добави тази страница в отметки
...
zen-compact-mode-shortcut-toggle = Превключи компактен режим
