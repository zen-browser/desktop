...
zen-standalone-window-header = Bağımsız pencereler
zen-standalone-window-description = Zen dışından açılan bağlantıların nasıl işleneceğini kontrol edin.
zen-standalone-window-enabled =
    .label = Harici bağlantıları bağımsız pencerelerde aç
