...
sync-currently-syncing-workspaces = Spásanna Oibre agus Cluaisíní
sync-engine-workspaces =
    .label = Spásanna Oibre agus Cluaisíní
    .tooltiptext = Sioncrónaigh do spásanna oibre agus cluaisíní trasna gléasanna
    .accesskey = W
