...
class nsZenViewSplitter extends nsZenDOMOperatedFeature {
  ...
  /**
 * Replaces a split-view tab with a non-split dragged tab in-place.
 * Called when the tab is dropped directly onto the center of a split browser
 * (no fakeBrowser zone was created — cursor was in the middle, not an edge).
 *
