...
zen-theme-marketplace-header = Addasiadau Astra
...
pane-zen-marketplace-title = Addasiadau Astra
...
zen-urlbar-title = Bar URL Astra
...
zenCKSOption-group-zen-other = Nodweddion Astra Eraill
...
zen-toggle-sidebar-shortcut = Toglo Bar Ochr Astra
