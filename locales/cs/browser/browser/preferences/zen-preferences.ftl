...
zen-standalone-window-header = Samostatná okna
zen-standalone-window-description = Nastavte, jak se zachází s odkazy otevřenými mimo Zen.
zen-standalone-window-enabled =
    .label = Otevírat externí odkazy v samostatných oknech
