...
zen-theme-marketplace-header = Modificações do Astra
...
pane-zen-marketplace-title = Modificações do Astra
...
zen-urlbar-title = Barra de URL Astra
...
category-zen-marketplace = 
    .tooltiptext = Modificações do Astra
...
zenCKSOption-group-zen-other = Outras Funcionalidades do Astra
...
zen-toggle-sidebar-shortcut = Alternar Barra Lateral do Astra
