...
zen-standalone-window-header = Janelas independentes
zen-standalone-window-description = Controle como os links abertos fora do Zen são tratados.
zen-standalone-window-enabled =
    .label = Abrir links externos em janelas independentes
