...
zen-tabs-cycle-by-attribute = 
    .label = Ctrl+Tab chỉ xoay vòng trong tab Thiết yếu hoặc Không gian làm việc
zen-tabs-cycle-ignore-pending-tabs = 
    .label = Bỏ qua các tab đang chờ xử lý khi đạp xe bằng Ctrl+Tab
zen-tabs-cycle-by-attribute-warning = Ctrl+Tab sẽ quay vòng theo thứ tự được sử dụng gần đây khi nó được bật
zen-look-and-feel-compact-toolbar-themed = 
    .label = Sử dụng nền theo chủ đề cho thanh công cụ nhỏ gọn
...
zen-settings-workspaces-force-container-tabs-to-workspace = 
    .label = Chuyển sang không gian làm việc nơi vùng chứa được đặt làm mặc định khi mở tab vùng chứa
...
zen-toggle-pin-tab-shortcut = Bật/tắt ghim tab
...
zen-glance-expand = Mở rộng Nhìn thoáng qua
...
zen-new-empty-split-view-shortcut = Chế độ xem phân chia trống mới
...
zen-close-all-unpinned-tabs-shortcut = Đóng tất cả các tab đã bỏ ghim
