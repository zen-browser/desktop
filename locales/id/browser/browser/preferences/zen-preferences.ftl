...
zen-standalone-window-header = Jendela mandiri
zen-standalone-window-description = Atur cara menangani tautan yang dibuka dari luar Zen.
zen-standalone-window-enabled =
    .label = Buka tautan eksternal di jendela mandiri
