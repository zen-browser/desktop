...
zen-theme-marketplace-header = שפצורים של Astra
...
pane-zen-marketplace-title = שפצורים של Astra
...
zen-urlbar-title = סרגל כתובת של Astra
...
zenCKSOption-group-zen-other = תכונות אחרות של Astra
...
zen-toggle-sidebar-shortcut = הפעל/כבה סרגל צד של Astra
