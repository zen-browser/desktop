...
zen-look-and-feel-window-drag-header = Venster verslepen
zen-look-and-feel-window-drag-description = Verplaats het venster door de lege ruimte aan de bovenkant van websites te verslepen, net zoals de titelbalk.
zen-window-drag-enabled = 
    .label = Verslepen van venster vanaf webpagina's toestaan
...
zen-search-find-again-shortcut-alt = Opnieuw zoeken (alternatief)
zen-search-find-again-shortcut-prev-alt = Vorige zoeken (alternatief)
...
zen-workspace-shortcut-create = Werkruimte aanmaken
...
zen-key-find-selection = Selectie zoeken
