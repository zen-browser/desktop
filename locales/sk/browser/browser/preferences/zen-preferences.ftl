...
sync-currently-syncing-workspaces = Pracovné priestory a karty
sync-engine-workspaces =
    .label = Pracovné priestory a karty
    .tooltiptext = Synchronizujte pracovné priestory a karty medzi zariadeniami
    .accesskey = W
