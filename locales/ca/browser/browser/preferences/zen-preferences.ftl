...
sync-currently-syncing-workspaces = Espais de treball i pestanyes
sync-engine-workspaces =
    .label = Espais de treball i pestanyes
    .tooltiptext = Sincronitza els espais de treball i les pestanyes entre dispositius
    .accesskey = W
