...
zen-standalone-window-header = Самостоятелни прозорци
zen-standalone-window-description = Управлявайте начина, по който се обработват връзките, отворени извън Zen.
zen-standalone-window-enabled =
    .label = Отваряне на външни връзки в самостоятелни прозорци
