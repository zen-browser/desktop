...
zen-standalone-window-header = Eigenständige Fenster
zen-standalone-window-description = Steuern, wie Links behandelt werden, die außerhalb von Zen geöffnet werden.
zen-standalone-window-enabled =
    .label = Externe Links in eigenständigen Fenstern öffnen
