...
zen-standalone-window-header = Samostatné okná
zen-standalone-window-description = Nastavte, ako sa zaobchádza s odkazmi otvorenými mimo Zen.
zen-standalone-window-enabled =
    .label = Otvárať externé odkazy v samostatných oknách
