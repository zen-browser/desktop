...
zen-standalone-window-header = النوافذ المستقلة
zen-standalone-window-description = التحكم في كيفية التعامل مع الروابط المفتوحة من خارج Zen.
zen-standalone-window-enabled =
    .label = فتح الروابط الخارجية في نوافذ مستقلة
