...
zen-tabs-select-recently-used-on-close = 
    .label = Når du lukker en fane, skift til den senest brugte fane i stedet for den næste fane
zen-tabs-close-on-back-with-no-history = 
    .label = Luk fane og skift til dens ejer-fane (eller senest brugte fane), når du går tilbage uden historik
zen-settings-workspaces-sync-unpinned-tabs = 
    .label = Synkroniser kun fastgjorte faneblade i arbejdsområder
zen-tabs-cycle-by-attribute = 
    .label = Ctrl+Tab cyklusser kun i fanebladet Essential eller Workspace
zen-tabs-cycle-ignore-pending-tabs = 
    .label = Ignorer Afventende faner ved cykling med Ctrl+Tab
zen-tabs-cycle-by-attribute-warning = Ctrl+Tab vil cykle af nyligt brugt rækkefølge, da det er aktiveret
zen-look-and-feel-compact-toolbar-themed = 
    .label = Brug tema baggrund til kompakt værktøjslinje
...
pane-zen-marketplace-title = Zen-temaer
...
zen-toggle-pin-tab-shortcut = Skift Pin-faneblad
...
zen-workspace-shortcut-create = Opret Nyt Arbejdsområde
...
zen-new-empty-split-view-shortcut = Ny Tom Opdelt Visning
...
zen-close-all-unpinned-tabs-shortcut = Luk Alle Ufastgjorte Faneblade
zen-new-unsynced-window-shortcut = New Unsynced Window
zen-duplicate-tab-shortcut = Duplicate Tab
zen-key-find-selection = Find Valg
