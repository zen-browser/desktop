...
zen-standalone-window-header = Atskiri langai
zen-standalone-window-description = Valdykite, kaip tvarkomos ne „Zen“ atidarytos nuorodos.
zen-standalone-window-enabled =
    .label = Atidaryti išorines nuorodas atskiruose languose
