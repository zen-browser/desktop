...
zen-tabs-close-on-back-with-no-history = 
    .label = 无历史记录情况下后退时关闭标签页并切换到其所属标签页(或最近使用的标签页)
zen-tabs-cycle-by-attribute = 
    .label = Ctrl+Tab 仅在「基本」或「工作区」标签页内轮换
zen-tabs-cycle-ignore-pending-tabs = 
    .label = 在使用 Ctrl+Tab 轮换时忽略未定的标签页
zen-tabs-cycle-by-attribute-warning = Ctrl+Tab 随其启用时将按最近使用的顺序轮换
...
zen-key-conflict = 与 { $group } -> { $shortcut } 冲突
...
zen-text-action-copy-url-markdown-shortcut = 复制当前URL为Markdown
...
zen-reader-mode-toggle-shortcut-other = 切换阅读器模式
...
zen-new-empty-split-view-shortcut = 新建空白拆分视图
