...
zen-window-sync-migration-dialog-message = El Astra ara sincronitza les finestres del mateix dispositiu, de manera que els canvis en una finestra es reflecteixen a les altres a l'instant.
