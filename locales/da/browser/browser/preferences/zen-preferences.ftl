...
sync-currently-syncing-workspaces = Arbejdsområder og faner
sync-engine-workspaces =
    .label = Arbejdsområder og faner
    .tooltiptext = Synkroniser dine arbejdsområder og faner på tværs af enheder
    .accesskey = W
