...
zen-theme-marketplace-header = Mods Astra
...
pane-zen-marketplace-title = Mods Astra
...
zen-urlbar-title = Barre d'adresse de Astra
...
zenCKSOption-group-zen-other = Autres fonctionnalités de Astra
...
zen-toggle-sidebar-shortcut = Activer/désactiver la barre latérale de Astra
