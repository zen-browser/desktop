...
zen-look-and-feel-window-drag-header = Ablak húzása
zen-look-and-feel-window-drag-description = Az ablakot úgy mozgathatod, hogy a weboldalak tetején lévő üres területet húzod, akárcsak a címsor esetében.
zen-window-drag-enabled = 
    .label = Ablak húzása weboldalakról
...
zen-search-find-again-shortcut-alt = Keresés újra (Alt)
zen-search-find-again-shortcut-prev-alt = Előző keresése (Alt)
