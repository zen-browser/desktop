...
zen-workspace-continue-where-left-off = 
    .label = 从之前离开的页面继续
pane-zen-pinned-tab-manager-title = 置顶标签页
zen-pinned-tab-manager-header = 置顶标签页的常规设置
zen-pinned-tab-manager-description = 管理置顶标签页的附加行为
...
zenCKSOption-group-zen-other = 其他 Zen 功能
...
zen-pinned-tab-shortcut-reset = 重置置顶标签页至其置顶的 URL
...
zen-close-all-unpinned-tabs-shortcut = 关闭所有未置顶的标签页
