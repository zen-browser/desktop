...
zen-theme-marketplace-header = Astra Módy
...
pane-zen-marketplace-title = Astra Módy
...
zen-urlbar-title = Astra adresní řádek
...
zenCKSOption-group-zen-other = Ostatní funkce Astra
...
zen-toggle-sidebar-shortcut = Přepnout postranní panel Astra
