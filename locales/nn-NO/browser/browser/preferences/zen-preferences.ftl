...
sync-currently-syncing-workspaces = Arbeidsområde og faner
sync-engine-workspaces =
    .label = Arbeidsområde og faner
    .tooltiptext = Synkroniser arbeidsområda og fanene dine på tvers av einingar
    .accesskey = W
