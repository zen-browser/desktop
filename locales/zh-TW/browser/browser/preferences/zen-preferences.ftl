...
zen-look-and-feel-window-drag-header = 視窗拖曳
zen-look-and-feel-window-drag-description = 按住網頁上方空白處，可如同按住標題列一般拖曳視窗。
...
zen-search-find-again-shortcut-alt = 再次尋找（備用快捷鍵）
zen-search-find-again-shortcut-prev-alt = 找上一個（備用快捷鍵）
