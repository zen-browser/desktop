...
zen-standalone-window-header = Cửa sổ độc lập
zen-standalone-window-description = Kiểm soát cách xử lý các liên kết được mở từ bên ngoài Zen.
zen-standalone-window-enabled =
    .label = Mở liên kết bên ngoài trong cửa sổ độc lập
