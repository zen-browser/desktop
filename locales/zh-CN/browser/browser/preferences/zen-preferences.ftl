...
zen-tabs-close-on-back-with-no-history = 
    .label = 在无历史记录的情况下后退时关闭标签页并切换到其属主标签页(或最近使用的标签页)
zen-tabs-cycle-by-attribute = 
    .label = Ctrl+Tab 仅在基本或工作空间标签页内轮换
zen-tabs-cycle-ignore-pending-tabs = 
    .label = 在用 Ctrl+Tab 轮换时忽略处理中标签页
zen-tabs-cycle-by-attribute-warning = 因其启用，Ctrl+Tab 将按近期使用顺序轮换
zen-look-and-feel-compact-toolbar-themed = 
    .label = 对紧凑工具栏使用主题化的背景
