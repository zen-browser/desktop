...
zen-settings-workspaces-sync = 
    .label = Synchronisez vos espaces de travail sur plusieurs appareils
    .description = Gardez vos espaces de travail, onglets épinglés et dossiers synchronisés sur tous vos appareils via votre compte Mozilla.
