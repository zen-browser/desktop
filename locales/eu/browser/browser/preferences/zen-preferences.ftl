...
zen-theme-marketplace-close-modal = Itxi
...
zenCKSOption-group-zen-compact-mode = Modu Trinkoa
...
zen-bookmark-this-page-shortcut = Gehitu Orria Laster-marketara
...
zen-compact-mode-shortcut-toggle = Modu Trinkoa Aktibatu/Desaktibatu
...
zen-new-unsynced-window-shortcut = Leiho zuri berria
