...
zen-settings-workspaces-sync = 
    .label = Синхронизируйте пространства между устройствами
    .description = Синхронизируйте ваши пространства, закрепленные вкладки и папки на всех ваших устройствах через учетную запись Mozilla.
