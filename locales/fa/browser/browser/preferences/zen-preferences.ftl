...
zen-standalone-window-header = پنجره‌های مستقل
zen-standalone-window-description = نحوه مدیریت پیوندهای بازشده خارج از Zen را کنترل کنید.
zen-standalone-window-enabled =
    .label = باز کردن پیوندهای خارجی در پنجره‌های مستقل
