...
const SVG_ICONS = [
  ...
  "checkbox.svg", "circle.svg", "close.svg", "cloud.svg", "code.svg",
  "coins.svg", "construct.svg", "cutlery.svg", "egg.svg",
  "essential-add.svg", "essential-remove.svg",
  ...
  "grid-3x3.svg", "heart.svg", "history.svg", "ice-cream.svg", "image.svg",
  "inbox.svg", "key.svg", "layers.svg", "leaf.svg",
  "lightning.svg", "link.svg", "location.svg", "lock-closed.svg", "logo-rss.svg",
  "logo-usd.svg", "mail.svg", "map.svg", "media-mute.svg", "media-unmute.svg", "megaphone.svg",
  "moon.svg", "music.svg", "navigate.svg", "nuclear.svg",
  "page.svg", "palette.svg", "paw.svg", "people.svg", "pin.svg", "unpin.svg",
  "pizza.svg", "planet.svg", "plus.svg", "present.svg", "private-window.svg", "reload.svg", "rocket.svg", "copy.svg", "new-tab.svg",
  "save.svg", "school.svg", "search-glass.svg", "send-to-device.svg", "shapes.svg", "share.svg", "shirt.svg", "skull.svg",
  ...
  "water.svg", "weight.svg", "window.svg",
];
