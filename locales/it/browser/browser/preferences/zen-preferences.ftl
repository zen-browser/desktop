...
zen-theme-marketplace-header = Astra Mod
...
pane-zen-marketplace-title = Astra Mod
...
zen-urlbar-title = Barra degli indirizzi di Astra
...
zenCKSOption-group-zen-other = Altre Caratteristiche Astra
...
zen-toggle-sidebar-shortcut = Attiva/Disattiva La Barra Laterale di Astra
