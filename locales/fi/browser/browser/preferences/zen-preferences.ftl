...
zen-tabs-select-recently-used-on-close = 
    .label = Kun välilehti suljetaan, vaihda viimeksi käytettyyn välilehteen seuraavan välilehden sijaan
...
zen-settings-workspaces-sync-unpinned-tabs = 
    .label = Synkronoi vain kiinnitetyt välilehdet työtilassa
...
zen-workspace-shortcut-create = Luo Uusi Työtila
...
zen-key-find-selection = Etsi Valinta
