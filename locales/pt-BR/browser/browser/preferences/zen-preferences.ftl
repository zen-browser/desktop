...
zen-snap-title = Snap
zen-snap-header = Opções gerais do Snap
zen-snap-description = Acesso rápido a arquivos recentes e área de transferência ao fazer upload
zen-snap-enabled = 
    .label = Ativar Snap
zen-snap-position-label = Posição do modal
zen-snap-position-bottom-left = 
    .label = Inferior Esquerdo
zen-snap-position-bottom-center = 
    .label = Inferior Centro (Padrão)
