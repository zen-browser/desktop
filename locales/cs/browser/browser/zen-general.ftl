...
zen-pinned-tab-url-edited = Připnuté URL záložky byla aktualizována!
zen-pinned-tab-url-invalid = To nevypadá jako platná adresa URL.
zen-pinned-tab-edit-url-title = Upravit připnutou URL
