...
zen-standalone-window-header = Frittstående vinduer
zen-standalone-window-description = Styr hvordan lenker som åpnes utenfor Zen, håndteres.
zen-standalone-window-enabled =
    .label = Åpne eksterne lenker i frittstående vinduer
