...
zen-theme-marketplace-header = Astra modok
...
pane-zen-marketplace-title = Astra modok
...
zen-urlbar-title = Astra URL sáv
...
zenCKSOption-group-zen-other = Egyéb Astra funkciók
...
zen-toggle-sidebar-shortcut = Astra oldalsáv ki-/bekapcsolása
