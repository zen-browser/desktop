...
sync-currently-syncing-workspaces = Spații de lucru și file
sync-engine-workspaces =
    .label = Spații de lucru și file
    .tooltiptext = Sincronizează spațiile de lucru și filele între dispozitive
    .accesskey = W
