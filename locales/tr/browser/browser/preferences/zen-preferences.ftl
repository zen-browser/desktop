...
zen-theme-marketplace-header = Astra Modları
...
pane-zen-marketplace-title = Astra Modları
...
zen-urlbar-title = Astra URL Çubuğu
...
zenCKSOption-group-zen-other = Diğer Astra Özellikleri
...
zen-toggle-sidebar-shortcut = Astra kenar çubuğunu aç/kapat
