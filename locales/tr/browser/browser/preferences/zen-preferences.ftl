...
sync-currently-syncing-workspaces = Çalışma Alanları ve Sekmeler
sync-engine-workspaces =
    .label = Çalışma Alanları ve Sekmeler
    .tooltiptext = Cihazlar arasında çalışma alanlarını ve sekmeleri eşitle
    .accesskey = W
