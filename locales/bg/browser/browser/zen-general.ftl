...
zen-window-sync-migration-dialog-message = Astra вече синхронизира прозорците на едно и също устройство, така че промените в един прозорец се отразяват незабавно във всички останали.
