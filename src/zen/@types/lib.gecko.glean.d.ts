...
interface GleanImpl {
  ...
  networking: {
    captivePortalBannerDisplayTime: Record<
      "abort" | "dismiss" | "success",
      GleanCounter
    >;
    ...
    httpResponseStatusCode: Record<
      ...
      GleanCounter
    >;
    httpResponseVersion: Record<
      "http_1" | "http_2" | "http_3" | "unknown",
      GleanCounter
    >;
    ...
    httpsHttpOrLocal: Record<
      ...
      GleanCounter
    >;
    httpsRrPresented: Record<
      "none" | "presented" | "presented_with_http3",
      GleanCounter
    >;
  ...
  securityUiProtectionspopup: {
    ...
    clickSmartblockembedsToggle: GleanEventWithExtras<{
      isBlock?: string;
    ...
    openProtectionspopupCfr: GleanEventWithExtras<{
      message?: string;
      value?: string;
    }>;
  ...
  firefoxviewNext: {
    browserContextMenuTabs: GleanEventWithExtras<{
      menu_action?: string;
      page?: string;
    }>;
    ...
    changePageNavigation: GleanEventWithExtras<{
      page?: string;
      source?: string;
    }>;
    closeOpenTabTabs: GleanEventNoExtras;
    contextMenuTabs: GleanEventWithExtras<{
      data_type?: string;
      menu_action?: string;
    }>;
    ...
    recentlyClosedTabs: GleanEventWithExtras<{
      delta?: string;
      page?: string;
      position?: string;
    }>;
    ...
    sortHistoryTabs: GleanEventWithExtras<{
      search_start?: string;
      sort_type?: string;
    }>;
  ...
  genaiChatbot: {
    ...
    lengthDisclaimer: GleanEventWithExtras<{
      length?: string;
      provider?: string;
      type?: string;
    }>;
    lengthDisclaimerDismissed: GleanEventWithExtras<{
      provider?: string;
      type?: string;
    }>;
    menu: GleanBoolean;
    onboardingClose: GleanEventWithExtras<{ provider?: string; step?: string }>;
    onboardingFinish: GleanEventWithExtras<{
      provider?: string;
      step?: string;
    }>;
    onboardingLearnMore: GleanEventWithExtras<{
      provider?: string;
      step?: string;
    }>;
    onboardingProviderChoiceDisplayed: GleanEventWithExtras<{
      provider?: string;
      step?: string;
    }>;
    onboardingProviderSelection: GleanEventWithExtras<{
      provider?: string;
      step?: string;
    }>;
    ...
    providerChange: GleanEventWithExtras<{
      current?: string;
      previous?: string;
      surface?: string;
    }>;
    ...
    sidebarMoreMenuClick: GleanEventWithExtras<{
      action?: string;
      provider?: string;
    }>;
    sidebarMoreMenuDisplay: GleanEventWithExtras<{ provider?: string }>;
    sidebarProviderMenuClick: GleanEventWithExtras<{
      action?: string;
      provider?: string;
    }>;
  ...
  browser: {
    ...
    aiControlIsBlocking: Record<string, GleanBoolean>;
  ...
  browserLaunchedToHandle: {
    systemNotification: GleanEventWithExtras<{
      action?: string;
      name?: string;
    }>;
  };
  ...
  security: {
    ...
    evalUsageParentProcess: GleanEventWithExtras<{
      fileinfo?: string;
      value?: string;
    }>;
    evalUsageSystemContext: GleanEventWithExtras<{
      fileinfo?: string;
      value?: string;
    }>;
  ...
  newtab: {
    ...
    featureHighlightDismiss: GleanEventWithExtras<{
      feature?: string;
    ...
    featureHighlightOpen: GleanEventWithExtras<{
      feature?: string;
      newtab_visit_id?: string;
    }>;
    ...
    tooltipClick: GleanEventWithExtras<{
      feature?: string;
      newtab_visit_id?: string;
    }>;
    ...
    wallpaperHighlightCtaClick: GleanEventWithExtras<{
      newtab_visit_id?: string;
    }>;
    wallpaperHighlightDismissed: GleanEventWithExtras<{
      newtab_visit_id?: string;
    }>;
    ...
    weatherOptInSelection: GleanEventWithExtras<{
      newtab_visit_id?: string;
    ...
    widgetsListsUserEvent: GleanEventWithExtras<{
      newtab_visit_id?: string;
      user_action?: string;
    }>;
    ...
    widgetsTimerUserEvent: GleanEventWithExtras<{
      newtab_visit_id?: string;
      user_action?: string;
    }>;
  ...
  topsites: {
    ...
    prefChanged: GleanEventWithExtras<{
      new_value?: string;
      pref_name?: string;
    }>;
    rows: GleanQuantity;
  ...
  historySidebar: {
    ...
    cumulativeSearches: GleanCustomDistribution;
    filterType: Record<
      "day" | "dayandsite" | "lastvisited" | "site" | "visited",
      GleanCounter
    >;
  ...
  securityUiProtections: {
    clickLwAboutLink: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickLwOpenButton: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickLwSyncLink: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickMobileAppLink: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickMtrAboutLink: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickMtrReportLink: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickMtrSignupButton: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickSettingsLink: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickTrackersAboutLink: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickVpnAppLinkAndroid: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickVpnAppLinkIos: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickVpnBannerClose: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickVpnBannerLink: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    clickVpnCardLink: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    closeProtectionReport: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
    showProtectionReport: GleanEventWithExtras<{
      category?: string;
      value?: string;
    }>;
  ...
  sap: {
    ...
    searchFormCounts: GleanEventWithExtras<{
      provider_id?: string;
      source?: string;
    }>;
  };
  ...
  searchbar: {
    selectedResultMethod: Record<
      "click" | "enter" | "enterSelection",
      GleanCounter
    >;
  };
  ...
  serp: {
    ...
    adsBlockedCount: Record<
      "beyond_viewport" | "hidden_child" | "hidden_parent",
      GleanCounter
    >;
  ...
  urlbarSearchmode: {
    ...
    messagingSystem: Record<string, GleanCounter>;
  ...
  browserUiInteraction: {
    ...
    preferencesPaneAbout: Record<string, GleanCounter>;
    preferencesPaneAccessibility: Record<string, GleanCounter>;
    preferencesPaneAi: Record<string, GleanCounter>;
    preferencesPaneAppearance: Record<string, GleanCounter>;
    preferencesPaneContainers: Record<string, GleanCounter>;
    preferencesPaneDownloads: Record<string, GleanCounter>;
    ...
    preferencesPaneLanguages: Record<string, GleanCounter>;
    preferencesPaneMoreFromMozilla: Record<string, GleanCounter>;
    preferencesPanePasswordsAutofill: Record<string, GleanCounter>;
    preferencesPanePermissionsData: Record<string, GleanCounter>;
    ...
    preferencesPaneTabsBrowsing: Record<string, GleanCounter>;
  ...
  contextualManager: {
    ...
    toolbarAction: GleanEventWithExtras<{
      option_name?: string;
      trigger?: string;
    }>;
  };
  ...
  sidebar: {
    addonIconClick: GleanEventWithExtras<{
      addon_id?: string;
      sidebar_open?: string;
    }>;
  ...
  syncedTabs: {
    ...
    clickFxaAppMenu: GleanEventWithExtras<{
      filter?: string;
      tab_pos?: string;
    }>;
    clickFxaAvatarMenu: GleanEventWithExtras<{
      filter?: string;
      tab_pos?: string;
    }>;
    clickSyncedTabsSidebar: GleanEventWithExtras<{
      filter?: string;
      tab_pos?: string;
    }>;
  };
  ...
  browserUsage: {
    interaction: GleanEventWithExtras<{
      flow_id?: string;
      source?: string;
      widget_id?: string;
    }>;
  ...
  homepage: {
    preferenceIgnore: GleanEventWithExtras<{
      value?: string;
  ...
  devtoolsInspector: {
    fonteditorFontTypeDisplayed: Record<
  ...
  devtoolsMain: {
    ...
    addBreakpointDebugger: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    blackboxDebugger: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    ...
    continueDebugger: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    ...
    editResendNetmonitor: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    editRuleRuleview: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    ...
    jumpToDefinitionWebconsole: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    jumpToSourceWebconsole: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    objectExpandedWebconsole: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    ...
    persistChangedNetmonitor: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    persistChangedWebconsole: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    prettyPrintDebugger: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    removeBreakpointDebugger: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    ...
    selectWsFrameNetmonitor: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
    ...
    startWorkerApplication: GleanEventWithExtras<{
      session_id?: string;
      value?: string;
    }>;
  ...
  mediaMp4Parse: {
    ...
    sampleDescriptionEntriesHaveMultipleCodecs: Record<
      "false" | "true",
      GleanCounter
    >;
    sampleDescriptionEntriesHaveMultipleCrypto: Record<
      "false" | "true",
      GleanCounter
    >;
  };
  ...
  dom: {
    ...
    gcInProgress: Record<string, GleanTimingDistribution>;
  ...
  serviceWorker: {
    ...
    fetchEventFinishSynthesizedResponse: Record<
      string,
      GleanTimingDistribution
    >;
  ...
  htmleditors: {
    ...
    withMutationObserversWithoutBeforeinputListeners: Record<
      "false" | "true",
      GleanCounter
    >;
  };
  ...
  permissions: {
    ...
    unusedPermissionsExpiredByType: Record<string, GleanCounter>;
  };
  ...
  gfxContent: {
    ...
    largePaintPhaseWeightFull: Record<
      "dl" | "fb" | "sb" | "wrdl",
      GleanCustomDistribution
    >;
    largePaintPhaseWeightPartial: Record<
      "dl" | "fb" | "sb" | "wrdl",
      GleanCustomDistribution
    >;
    paintTime: GleanTimingDistribution;
    smallPaintPhaseWeightFull: Record<
      "dl" | "fb" | "sb" | "wrdl",
      GleanCustomDistribution
    >;
    smallPaintPhaseWeightPartial: Record<
      "dl" | "fb" | "sb" | "wrdl",
      GleanCustomDistribution
    >;
  };
  ...
  gpuProcess: {
    crashFallbacks: Record<
      "decoding_disabled" | "disabled" | "none",
      GleanCounter
    >;
  ...
  avif: {
    ...
    >;
    bitDepth: Record<
      "color_10" | "color_12" | "color_16" | "color_8" | "unknown",
      GleanCounter
    >;
    cicpCp: Record<
      | "bt2020"
    ...
    yuvColorSpace: Record<
      "bt2020" | "bt601" | "bt709" | "identity" | "unknown",
      GleanCounter
    >;
  };
  ...
  javascriptGc: {
    animation: Record<string, GleanTimingDistribution>;
    budget: Record<string, GleanTimingDistribution>;
    budgetOverrun: Record<string, GleanTimingDistribution>;
    budgetWasIncreased: Record<"false" | "true", GleanCounter>;
    compactTime: Record<string, GleanTimingDistribution>;
    effectiveness: GleanCustomDistribution;
    isZoneGc: Record<"false" | "true", GleanCounter>;
    markGray: Record<string, GleanTimingDistribution>;
    markRate: GleanCustomDistribution;
    markRootsTime: Record<string, GleanTimingDistribution>;
    markTime: Record<string, GleanTimingDistribution>;
    markWeak: Record<string, GleanTimingDistribution>;
    maxPause: Record<string, GleanTimingDistribution>;
    minorReason: Record<
      | "ABORT_GC"
      | "ALLOC_TRIGGER"
      | "API"
    ...
    minorReasonLong: Record<
      ...
      GleanCounter
    >;
    minorTime: Record<string, GleanTimingDistribution>;
    ...
    nonIncrementalReason: Record<
      ...
      GleanCounter
    >;
    nurseryBytes: Record<string, GleanMemoryDistribution>;
    ...
    prepareTime: Record<string, GleanTimingDistribution>;
    ...
    sliceTime: Record<string, GleanTimingDistribution>;
    ...
    slowTask: Record<
      ...
      GleanCounter
    >;
    sweepTime: Record<string, GleanTimingDistribution>;
    taskStartDelay: Record<string, GleanTimingDistribution>;
    tenuredSurvivalRate: GleanCustomDistribution;
    timeBetween: Record<string, GleanTimingDistribution>;
    timeBetweenMinor: Record<string, GleanTimingDistribution>;
    timeBetweenSlices: Record<string, GleanTimingDistribution>;
    totalTime: Record<string, GleanTimingDistribution>;
  ...
  slowScriptWarning: {
    ...
    shownBrowser: GleanEventWithExtras<{
  ...
  network: {
    cacheEntryCount: Record<
      "SMARTSIZE" | "USERDEFINEDSIZE",
      GleanCustomDistribution
    >;
    ...
    corsAuthorizationHeader: Record<
      "allowed" | "covered_by_wildcard" | "disallowed",
      GleanCounter
    >;
  ...
  dns: {
    ...
    trrRelevantSkipReasonTrrFirstTypeRec: Record<
      string,
      GleanCustomDistribution
    >;
  ...
  networkCookies: {
    openError: Record<string, GleanCounter>;
  ...
  netwerk: {
    ...
    http30rttStateDuration: Record<
      ...
      GleanTimingDistribution
    >;
    http3TimeToReuseIdleConnection: Record<
      "failed" | "succeeded",
      GleanTimingDistribution
    >;
  ...
  pkcs11: {
    ...
    thirdPartyModuleSignatureType: GleanEventWithExtras<{
      filename?: string;
      signature?: string;
    }>;
  ...
  ssl: {
    ...
    timeUntilHandshakeFinishedKeyedByKa: Record<
      string,
      GleanTimingDistribution
    >;
  ...
  fxa: {
    ...
    connectAccount: GleanEventWithExtras<{
      fxa?: string;
      sync?: string;
      value?: string;
    }>;
    disconnectAccount: GleanEventWithExtras<{
      fxa?: string;
      sync?: string;
      value?: string;
    }>;
  ...
  contentblocking: {
    ...
    emailTrackerEmbeddedPerTab: Record<
      ...
      GleanCustomDistribution
    >;
    fingerprintersBlockedCount: Record<
      "allowed" | "blocked" | "pageLoad",
      GleanCounter
    >;
  ...
  address: {
    ...
    clearedAddressForm: GleanEventWithExtras<{
      field_name?: string;
      value?: string;
    }>;
    ...
    popupShownAddressForm: GleanEventWithExtras<{
      field_name?: string;
      value?: string;
    }>;
  ...
  formautofill: {
    ...
    promptShownOsReauth: GleanEventWithExtras<{
      result?: string;
      trigger?: string;
    }>;
  ...
  testOnly: {
    ...
    mabelsBalloonLabels: Record<
      "celebratory" | "celebratory_and_snarky",
      GleanString
    >;
    ...
    mabelsLabeledCounters: Record<
      "1st_counter" | "clean" | "next_to_the_fridge",
      GleanCounter
    >;
  ...
  messagingExperiments: {
    ...
    targetingAttributeTimeout: GleanEventWithExtras<{
      source?: string;
      value?: string;
    }>;
  };
  ...
  nimbusEvents: {
    ...
    enrollFailed: GleanEventWithExtras<{
      branch?: string;
      experiment?: string;
      reason?: string;
    }>;
    ...
    remoteSettingsSyncError: GleanEventWithExtras<{
      collection?: string;
      force_sync?: string;
      reason?: string;
      trigger?: string;
    ...
    unenrollFailed: GleanEventWithExtras<{
      experiment?: string;
      reason?: string;
    }>;
  ...
  pwmgr: {
    ...
    cancelNewLogin: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    copyPassword: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    copyUsername: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    deleteExistingLogin: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    deleteNewLogin: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    ...
    editExistingLogin: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    ...
    formAutofillResult: Record<
      ...
      GleanCounter
    >;
    hidePassword: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    ...
    learnMoreVulnExistingLogin: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    ...
    openSiteExistingLogin: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    osAuthEnabled: GleanBoolean;
    ...
    saveNewLogin: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    ...
    selectExistingLogin: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
    showPassword: GleanEventWithExtras<{
      breached?: string;
      vulnerable?: string;
    }>;
  ...
  relayIntegration: {
    ...
    clickedOfferRelay: GleanEventWithExtras<{
      scenario?: string;
      value?: string;
    }>;
  ...
  pdfjs: {
    ...
    >;
    editing: Record<
      "freetext" | "ink" | "print" | "save" | "signature" | "stamp",
      GleanCounter
    >;
    geckoview: Record<
      | "download_failed"
  ...
  pdfjsEditingHighlight: {
    ...
    method: Record<
      "context_menu" | "floating_button" | "main_toolbar",
      GleanCounter
    >;
    numberOfColors: Record<
  ...
  pdfjsImage: {
    ...
    iconClick: GleanEventNoExtras;
    imageAdded: GleanEventWithExtras<{
      alt_text_modal?: string;
  ...
  pdfjsSignature: {
    ...
    inserted: GleanEventWithExtras<{
      has_been_saved?: string;
  ...
  pictureinpicture: {
    ...
    resizePlayer: GleanEventWithExtras<{
      height?: string;
      value?: string;
      width?: string;
    }>;
  ...
  printing: {
    ...
    targetType: Record<
      "pdf_file" | "pdf_unknown" | "unknown" | "xps_file",
      GleanCounter
    >;
  };
  ...
  applicationReputation: {
    binaryArchive: Record<
      "DmgFile" | "OtherBinaryFile" | "RarFile" | "ZipFile",
      GleanCounter
    >;
    binaryType: Record<
      | "BinaryFile"
  ...
  telemetryTest: {
    test1Object1: GleanEventWithExtras<{
      key1?: string;
      key2?: string;
      value?: string;
    }>;
    test2Object1: GleanEventWithExtras<{
      key1?: string;
      key2?: string;
      value?: string;
    }>;
    test2Object2: GleanEventWithExtras<{
      key1?: string;
      key2?: string;
      value?: string;
    }>;
  ...
  translations: {
    ...
    identifyPageLanguage: GleanEventWithExtras<{
      confident?: string;
      extracted_code_units?: string;
      extraction_time?: string;
      html_lang_attribute?: string;
      identification_time?: string;
      identified_language?: string;
      is_lang_attribute_valid?: string;
  ...
  translationsPanel: {
    ...
    alwaysOfferTranslations: GleanEventWithExtras<{
      flow_id?: string;
      toggled_on?: string;
    }>;
    ...
    changeToLanguage: GleanEventWithExtras<{
      flow_id?: string;
      language?: string;
    }>;
    ...
    neverTranslateSite: GleanEventWithExtras<{
      flow_id?: string;
      toggled_on?: string;
    }>;
  ...
  serviceRequest: {
    bypassProxyInfo: GleanEventWithExtras<{
      source?: string;
      type?: string;
      value?: string;
    }>;
  ...
  addonsManager: {
    ...
    xpistatesWriteErrors: GleanEventWithExtras<{
      error_type?: string;
  ...
  cycleCollector: {
    asyncSnowWhiteFreeing: Record<string, GleanTimingDistribution>;
    collected: GleanCustomDistribution;
    deferredFinalizeAsync: Record<string, GleanTimingDistribution>;
    finishIgc: Record<"false" | "true", GleanCounter>;
    forgetSkippableMax: Record<string, GleanTimingDistribution>;
    full: Record<string, GleanTimingDistribution>;
    maxPause: Record<string, GleanTimingDistribution>;
    needGc: Record<"false" | "true", GleanCounter>;
    sliceDuringIdle: GleanCustomDistribution;
    syncSkippable: Record<"false" | "true", GleanCounter>;
    time: Record<string, GleanTimingDistribution>;
    timeBetween: Record<string, GleanTimingDistribution>;
    ...
    workerTime: Record<string, GleanTimingDistribution>;
...
interface GleanPingsImpl {
  ...
  serpCategorization: GleanPingWithReason<
    "inactivity" | "startup" | "threshold_reached"
  >;
...
type GleanEventWithExtras<T> = Omit<GleanEvent, "record"> & {
  record(extras: T);
};

type GleanPingNoReason = Omit<nsIGleanPing, "submit"> & { submit(_?: never) };
type GleanPingWithReason<T> = Omit<nsIGleanPing, "submit"> & {
  submit(reason: T);
};
