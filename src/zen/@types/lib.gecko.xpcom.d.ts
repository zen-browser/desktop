...
declare enum nsIDocumentViewer_PermitUnloadResult {
  eContinue = 0,
  eCanceledByBeforeUnload = 1,
  eCanceledByNavigate = 2,
}
...
declare global {
  ...
  interface nsIBrowserDOMWindow extends nsISupports {
    ...
    readonly OPEN_NEWTAB_AFTER_CURRENT?: 7;
    readonly OPEN_NEW?: 0;
...
declare global {
  ...
  interface nsIDOMWindowUtils
    extends nsISupports, Enums<typeof nsIDOMWindowUtils_AsyncEnabledOption> {
...
declare global {
  ...
  interface nsINotificationStorage extends nsISupports {
    put(
      aOrigin: string,
      aEntry: nsINotificationStorageEntry,
      aScope: string
    ): void;
    get(
      origin: string,
...
declare global {
  ...
  interface nsIHelperAppLauncherDialog
    extends nsISupports, Enums<typeof nsIHelperAppLauncherDialog_reason> {
    show(
...
declare global {
  ...
  interface imgIEncoder
    extends
      nsIAsyncInputStream,
      Enums<
        typeof imgIEncoder_CICPColourPrimaries &
          typeof imgIEncoder_CICPTransferCharacteristics &
          typeof imgIEncoder_CICPMatrixCoefficients
      > {
    ...
    setColorSpaceInfo(
      colourPrimaries: imgIEncoder.CICPColourPrimaries,
      transferCharacteristics: imgIEncoder.CICPTransferCharacteristics,
      matrixCoefficients: imgIEncoder.CICPMatrixCoefficients,
      fullRange: boolean
    ): void;
    initFromData(
      data: u8[],
...
declare global {
  ...
  interface nsILoginManager extends nsISupports {
    ...
    reencryptAllLogins(): Promise<any>;
    listInvalidOrigins(): Promise<any>;
    ...
    addPotentiallyVulnerablePassword(aLogin: nsILoginInfo): Promise<any>;
    isPotentiallyVulnerablePassword(aLogin: nsILoginInfo): Promise<any>;
    recordBreachAlertDismissal(aLoginGUID: string): Promise<any>;
    getBreachAlertDismissalsByLoginGUID(): Promise<any>;
    arePotentiallyVulnerablePasswords(aLogins: any): Promise<any>;
    clearAllPotentiallyVulnerablePasswords(): Promise<any>;
...
declare enum nsILoadInfo_StoragePermissionState {
  ...
  DisabledStoragePermission = 3,
  InactiveStoragePermission = 4,
}
...
declare global {
  ...
  interface nsIRedirectChannelRegistrar extends nsISupports {
    ...
    linkChannels(
      id: u64,
      aContentParentId: u64,
      channel: nsIParentChannel
    ): nsIChannel;
...
declare global {
  ...
  interface nsICookieManager extends nsISupports {
    ...
    addThirdPartyCookieBlockingExceptions(
      aExcpetions: nsIThirdPartyCookieExceptionEntry[]
    ): void;
...
declare global {
  ...
  interface nsIHttpChannelInternal
    extends nsISupports, Enums<typeof nsIHttpChannelInternal_ProxyDNSStrategy> {
...
declare global {
  ...
  interface nsIX509CertDB
    extends
      nsISupports,
      Enums<
        typeof nsIX509CertDB_VerifyUsage &
          typeof nsIX509CertDB_QWACType &
          typeof nsIX509CertDB_PDFSignatureAlgorithm
      > {
    ...
    asyncVerifyQWAC(
      type: nsIX509CertDB.QWACType,
      cert: nsIX509Cert,
      hostname: string,
      collectedCerts: nsIX509Cert[]
    ): Promise<any>;
    asyncVerifyPKCS7Object(
      pkcs7: u8[],
      data: u8[][],
      signatureType: nsIX509CertDB.PDFSignatureAlgorithm
    ): Promise<any>;
  }
...
declare global {
  ...
  interface mozIPlacesAutoComplete
    extends
      nsISupports,
      Enums<
        typeof mozIPlacesAutoComplete_MatchBehaviors &
          typeof mozIPlacesAutoComplete_SearchBehaviors
      > {}
...
declare global {
  namespace nsINavBookmarksService {
    type BookmarkType = nsINavBookmarksService_BookmarkType;
  ...
  interface nsINavBookmarksService
    extends
      nsISupports,
      Enums<
        typeof nsINavBookmarksService_BookmarkType &
...
declare enum nsINavHistoryQueryOptions_ResultType {
  RESULTS_AS_URI = 0,
  RESULTS_AS_VISIT = 1,
...
declare global {
  namespace nsINavHistoryQueryOptions {
    type SortByType = nsINavHistoryQueryOptions_SortByType;
    type ResultType = nsINavHistoryQueryOptions_ResultType;
  }
  ...
  interface nsINavHistoryQueryOptions
    extends
      nsISupports,
      Enums<
        typeof nsINavHistoryQueryOptions_SortByType &
          typeof nsINavHistoryQueryOptions_ResultType
      > {
...
declare global {
  ...
  interface nsIPrefBranch
    extends nsISupports, Enums<typeof nsIPrefBranch_PreferenceType> {
  ...
  interface nsIPrefService extends nsISupports {
    ...
    backupPrefFile(
      aFile: nsIFile,
      aOverrideMap?: nsIPrefOverrideMap
    ): Promise<any>;
...
declare global {
  ...
  interface nsIScopedPrefs
    extends nsISupports, Enums<typeof nsIScopedPrefs_Pref> {
    setBoolPrefScoped(
...
declare global {
  ...
  interface nsIUrlClassifierStreamUpdater extends nsISupports {
    downloadUpdates(
      ...
      aRequestQueryParameters: string,
  ...
  interface nsIUrlClassifierUtils extends nsISupports {
    ...
    makeFindFullHashRequestV5(aHashPrefixes: string[]): string;
    makeThreatHitReport(
      aChannel: nsIChannel,
      aListName: string,
      aHashBase64: string
...
declare global {
  namespace nsIGfxInfo {
    type FontVisibilityDeviceDetermination =
...
declare global {
  ...
  interface nsIINIParserFactory extends nsISupports {
    createINIParser(
      aINIFile?: nsIFile,
      aContainedErrors?: OutParam<boolean>
    ): nsIINIParser;
  }
...
declare enum nsIEventTarget_DispatchFlags {
  ...
  DISPATCH_IGNORE_BLOCK_DISPATCH = 8,
...
declare global {
  ...
  interface nsIXPCComponents_Utils extends nsISupports {
    ...
    setSandboxLocaleOverride(sandbox: any, locale: string): void;
    setSandboxTimezoneOverride(sandbox: any, timezone: string): void;
...
declare global {
  ...
  // https://searchfox.org/firefox-main/source/zen/toolkit/common/nsIZenCommonUtils.idl
  ...
  // https://searchfox.org/firefox-main/source/zen/mods/nsIZenModsBackend.idl
  ...
  interface nsIXPCComponents_Interfaces {
    ...
    nsIAppStartup: nsJSIID<
      nsIAppStartup,
      typeof nsIAppStartup_IDLShutdownPhase
    >;
    ...
    nsIDOMWindowUtils: nsJSIID<
      nsIDOMWindowUtils,
      typeof nsIDOMWindowUtils_AsyncEnabledOption
    >;
    ...
    nsIReferrerInfo: nsJSIID<
      nsIReferrerInfo,
      typeof nsIReferrerInfo_ReferrerPolicyIDL
    >;
    ...
    nsIHelperAppLauncherDialog: nsJSIID<
      nsIHelperAppLauncherDialog,
      typeof nsIHelperAppLauncherDialog_reason
    >;
    ...
    nsIKeyValueService: nsJSIID<
      nsIKeyValueService,
      typeof nsIKeyValueService_RecoveryStrategy
    >;
    ...
    nsIClassOfService: nsJSIID<
      nsIClassOfService,
      typeof nsIClassOfService_FetchPriority
    >;
    ...
    nsITimedChannel: nsJSIID<
      nsITimedChannel,
      typeof nsITimedChannel_BodyInfoAccess
    >;
    ...
    nsICookieNotification: nsJSIID<
      ...
      typeof nsICookieNotification_Action
    >;
    ...
    nsICookieValidation: nsJSIID<
      nsICookieValidation,
      typeof nsICookieValidation_ValidationError
    >;
    ...
    nsIHttpChannelInternal: nsJSIID<
      nsIHttpChannelInternal,
      typeof nsIHttpChannelInternal_ProxyDNSStrategy
    >;
    ...
    mozIPlacesAutoComplete: nsJSIID<
    ...
    nsINavHistoryQueryOptions: nsJSIID<
      nsINavHistoryQueryOptions,
      typeof nsINavHistoryQueryOptions_SortByType &
        typeof nsINavHistoryQueryOptions_ResultType
    >;
    nsINavHistoryService: nsJSIID<
      nsINavHistoryService,
      typeof nsINavHistoryService_TransitionType
    >;
    ...
    >;
    nsIBounceTrackingRecord: nsJSIID<nsIBounceTrackingRecord>;
    ...
    nsIScopedPrefs: nsJSIID<nsIScopedPrefs, typeof nsIScopedPrefs_Pref>;
    ...
    nsICookieBannerService: nsJSIID<
      ...
      typeof nsICookieBannerService_Modes
    >;
    ...
    nsIUrlClassifierTestUtils: nsJSIID<nsIUrlClassifierTestUtils>;
    ...
    nsIClipboardHelper: nsJSIID<
      nsIClipboardHelper,
      typeof nsIClipboardHelper_SensitiveData
    >;
    ...
    nsIGfxInfo: nsJSIID<
      nsIGfxInfo,
      typeof nsIGfxInfo_FontVisibilityDeviceDetermination
    >;
    ...
    nsIPrintSettings: nsJSIID<
      nsIPrintSettings,
      typeof nsIPrintSettings_OutputDestinationType
    >;
    ...
    nsIConsoleService: nsJSIID<
      nsIConsoleService,
      typeof nsIConsoleService_OutputMode
    >;
    ...
    nsIZenDragAndDrop: nsJSIID<nsIZenDragAndDrop>;
