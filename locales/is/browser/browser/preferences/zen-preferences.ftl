...
zen-theme-marketplace-header = Viðbrigðasnið Astra
...
pane-zen-marketplace-title = Viðbrigðasnið Astra
...
zen-urlbar-title = Astra-staðsetningastikan
...
category-zen-marketplace = 
    .tooltiptext = Viðbrigðasnið Astra
...
zenCKSOption-group-zen-other = Aðrir eiginleikar Astra
...
zen-toggle-sidebar-shortcut = Víxla Astra-hliðarstiku af/á
