...
sync-currently-syncing-workspaces = Работни пространства и раздели
sync-engine-workspaces =
    .label = Работни пространства и раздели
    .tooltiptext = Синхронизирайте работните пространства и разделите между устройствата
    .accesskey = W
