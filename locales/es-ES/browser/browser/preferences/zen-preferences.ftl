...
sync-currently-syncing-workspaces = Espacios de trabajo y pestañas
sync-engine-workspaces =
    .label = Espacios de trabajo y pestañas
    .tooltiptext = Sincronice sus espacios de trabajo y pestañas en todos sus dispositivos
    .accesskey = W
