...
sync-currently-syncing-workspaces = Рабочие пространства и вкладки
sync-engine-workspaces =
    .label = Рабочие пространства и вкладки
    .tooltiptext = Синхронизируйте рабочие пространства и вкладки между устройствами
    .accesskey = Ц
