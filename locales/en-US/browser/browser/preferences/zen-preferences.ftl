...
zen-recommended-extensions-header = Recommended Extensions
zen-recommended-extensions-description = Install trusted add-ons from AMO and quickly enable or disable them here.
zen-recommended-extension-install-button =
    .label = Install
zen-recommended-extension-enable-button =
    .label = Enable
zen-recommended-extension-disable-button =
    .label = Disable
zen-recommended-extension-state-not-installed = Status: Not Installed
zen-recommended-extension-state-enabled = Status: Enabled
zen-recommended-extension-state-disabled = Status: Disabled
zen-recommended-extension-ublock-title = uBlock Origin (Ad Blocker)
zen-recommended-extension-ublock-description = Efficient ad and content blocker for faster, cleaner browsing.
zen-recommended-extension-bitwarden-title = Bitwarden (Password Manager)
zen-recommended-extension-bitwarden-description = Open-source password manager for secure sign-ins.
zen-recommended-extension-dark-reader-title = Dark Reader (Dark Mode)
zen-recommended-extension-dark-reader-description = Applies dark themes to websites for comfortable viewing.
zen-recommended-extension-proton-vpn-title = ProtonVPN (VPN)
zen-recommended-extension-proton-vpn-description = Privacy-focused VPN browser extension from Proton.
zen-recommended-extension-privacy-badger-title = Privacy Badger (Tracker Blocker)
zen-recommended-extension-privacy-badger-description = Automatically learns and blocks invisible trackers.
...
zen-folder-quick-search-shortcut = Folder Quick Search
