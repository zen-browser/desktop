...
context-zen-change-workspace-tab = 
    .label = Færa flipa/flipum yfir í vinnusvæði
    .accesskey = B
...
zen-panel-ui-gradient-generator-algo-floating = 
    .label = Fljótandi
zen-panel-ui-gradient-click-to-add = Smelltu hér til að bæta við lit
zen-workspace-creation-name = 
    .placeholder = Nafn vinnusvæðis
zen-workspaces-panel-context-reorder = 
    .label = Endurraða vinnusvæðum
zen-workspace-creation-profile = Kómenta
    .tooltiptext = Kómentur eru til þess að aðskilja vefkökur og gögn vefsvæða á milli vinnusvæða.
