...
zen-standalone-window-header = Ventanas independientes
zen-standalone-window-description = Controla cómo se gestionan los enlaces abiertos desde fuera de Zen.
zen-standalone-window-enabled =
    .label = Abrir enlaces externos en ventanas independientes
