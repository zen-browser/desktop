...
zen-action-split-tabs-vertically = Split Tabs Vertically
zen-action-split-tabs-horizontally = Split Tabs Horizontally
zen-action-split-tabs-grid = Split Tabs as Grid
zen-action-unsplit-view = Unsplit View
zen-action-new-space = New Space
zen-action-unload-space = Unload Current Space
...
zen-action-duplicate-tab = Duplicate Tab
zen-action-reset-pinned-tab = Reset Pinned Tab
zen-action-replace-pinned-url = Replace Pinned URL with Current
...
zen-action-show-all-history = Show All History
