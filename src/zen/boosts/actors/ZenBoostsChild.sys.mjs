...
export class ZenBoostsChild extends JSWindowActorChild {
  ...
  async #applyBoostForPageIfAvailable() {
    ...
    const domain = browsingContext.currentURI.host;
    ...
    if (gZenBoostsManager.registeredBoostForDomain(domain)) {
      ...
      browsingContext.prefersColorSchemeOverride =
        boostData.smartInvert ? 'light' : 'none';
      ...
      } else browsingContext.zenBoostsData = null;
    }
  }
