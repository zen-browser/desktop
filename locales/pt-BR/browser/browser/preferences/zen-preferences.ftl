...
sync-currently-syncing-workspaces = Áreas de Trabalho e Abas
sync-engine-workspaces =
    .label = Áreas de Trabalho e Abas
    .tooltiptext = Sincronize suas áreas de trabalho e abas entre dispositivos
    .accesskey = W
