...
zen-standalone-window-header = Selvstændige vinduer
zen-standalone-window-description = Styr, hvordan links åbnet uden for Zen håndteres.
zen-standalone-window-enabled =
    .label = Åbn eksterne links i selvstændige vinduer
