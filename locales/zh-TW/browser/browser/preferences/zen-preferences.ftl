...
zen-theme-marketplace-header = Astra 模組
...
zen-theme-marketplace-input-default-placeholder = 
    .placeholder = 請輸入...
pane-zen-marketplace-title = Astra 模組
...
zenCKSOption-group-zen-other = 其它 Astra 功能
...
zen-toggle-sidebar-shortcut = 開啟 Astra 側邊欄
