...
zen-theme-marketplace-header = Astra Моди
...
pane-zen-marketplace-title = Astra Моди
...
zen-urlbar-title = Рядок URL-адрес Astra
...
zenCKSOption-group-zen-other = Інші функції Astra
...
zen-toggle-sidebar-shortcut = Перемкнути бічну панель Astra
