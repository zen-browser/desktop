...
sync-currently-syncing-workspaces = Робочі області та вкладки
sync-engine-workspaces =
    .label = Робочі області та вкладки
    .tooltiptext = Синхронізуйте ваші робочі області та вкладки між пристроями
    .accesskey = Пт
