...
zen-standalone-window-header = Leiho autonomoak
zen-standalone-window-description = Kontrolatu Zenetik kanpo irekitako estekak nola kudeatzen diren.
zen-standalone-window-enabled =
    .label = Ireki kanpoko estekak leiho autonomoetan
