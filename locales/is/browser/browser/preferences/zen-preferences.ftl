...
zen-standalone-window-header = Sjálfstæðir gluggar
zen-standalone-window-description = Stjórnaðu því hvernig tenglar sem opnaðir eru utan Zen eru meðhöndlaðir.
zen-standalone-window-enabled =
    .label = Opna ytri tengla í sjálfstæðum gluggum
