...
sync-currently-syncing-workspaces = Không gian làm việc và thẻ
sync-engine-workspaces =
    .label = Không gian làm việc và thẻ
    .tooltiptext = Đồng bộ hóa không gian làm việc và thẻ giữa các thiết bị
    .accesskey = W
