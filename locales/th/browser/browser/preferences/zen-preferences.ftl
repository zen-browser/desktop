...
zen-standalone-window-header = หน้าต่างแยกอิสระ
zen-standalone-window-description = ควบคุมวิธีจัดการลิงก์ที่เปิดจากภายนอก Zen
zen-standalone-window-enabled =
    .label = เปิดลิงก์ภายนอกในหน้าต่างแยกอิสระ
