...
zen-standalone-window-header = Önálló ablakok
zen-standalone-window-description = A Zenen kívül megnyitott hivatkozások kezelésének beállítása.
zen-standalone-window-enabled =
    .label = Külső hivatkozások megnyitása önálló ablakokban
