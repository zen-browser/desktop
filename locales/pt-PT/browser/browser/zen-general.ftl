...
zen-window-sync-migration-dialog-message = Agora, o Astra sincroniza as janelas no dispositivo, pelo que alterações numa janela são refletidas instantaneamente nas outras.
