...
function SignAndPackage($name) {
    ...
    if ($name -eq "arm64") {
        $env:WIN32_REDIST_DIR="$PWD\win-cross\vs2026\VC\Redist\MSVC\14.51.36247\arm64\Microsoft.VC145.CRT"
    } else {
        $env:WIN32_REDIST_DIR="$PWD\win-cross\vs2026\VC\Redist\MSVC\14.51.36247\x64\Microsoft.VC145.CRT"
    }
