...
pane-zen-marketplace-title = Επεκτάσεις Astra
...
zen-urlbar-title = Γραμμή Astra URL
...
zenCKSOption-group-zen-other = Άλλες Λειτουργίες του Astra
...
zen-toggle-sidebar-shortcut = Εναλλαγή Πλευρικής Μπάρας Astra
