...
zen-layout-single-toolbar = Tylko panel boczny
zen-layout-multiple-toolbar = Panel boczny i górny pasek narzędzi
zen-layout-collapsed-toolbar = Zwinięty panel boczny
...
zen-settings-workspaces-sync = 
    .label = Synchronizuj panel boczny między urządzeniami
    .description = Utrzymuj synchronizację obszarów roboczych, przypiętych kart i folderów na wszystkich swoich urządzeniach za pomocą konta Mozilla.
...
zen-vertical-tabs-title = Panel boczny i układ kart
...
zen-vertical-tabs-expand-tabs-description = Wybierz sposób rozwijania kart na panelu bocznym
...
zen-history-sidebar-shortcut = Pokaż panel boczny historii
...
zen-ai-chatbot-sidebar-shortcut = Przełącz panel boczny asystenta AI
zen-key-inspector-mac = Przełącz tryb inspektora (Mac)
zen-toggle-sidebar-shortcut = Przełącz panel boczny Firefoksa
...
zen-compact-mode-shortcut-show-sidebar = Przełącz pływający panel boczny
...
zen-bookmark-show-sidebar-shortcut = Pokaż panel boczny zakładek
