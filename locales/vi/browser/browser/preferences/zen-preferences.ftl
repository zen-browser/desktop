...
zen-pinned-tab-manager-container-specific-essentials-enabled = 
    .label = Bật các thẻ thường trú riêng cho Container
...
zen-settings-workspaces-hide-default-container-indicator = 
    .label = Ẩn chỉ báo Container mặc định trên thanh tab
...
zen-settings-workspaces-force-container-tabs-to-workspace = 
    .label = Chuyển sang không gian làm việc mặc định của Container khi mở thẻ Container
...
zen-pinned-tab-shortcut-reset = Đưa thẻ đã ghim về dạng đường dẫn
