...
zen-layout-single-toolbar = Seulement la barre latérale
zen-layout-multiple-toolbar = Barre latérale et barre d'outils supérieure
zen-layout-collapsed-toolbar = Barre latérale réduite
