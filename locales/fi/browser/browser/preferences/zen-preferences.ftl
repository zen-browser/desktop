...
zen-theme-marketplace-header = Astra modit
...
pane-zen-marketplace-title = Astra modit
...
zen-urlbar-title = Astra URL-palkki
...
zenCKSOption-group-zen-other = Muut Astra-ominaisuudet
...
zen-toggle-sidebar-shortcut = Vaihda Astra Sivupalkkia
