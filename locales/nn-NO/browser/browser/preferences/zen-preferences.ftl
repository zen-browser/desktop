...
zen-standalone-window-header = Sjølvstendige vindauge
zen-standalone-window-description = Styr korleis lenkjer som blir opna utanfor Zen, blir handterte.
zen-standalone-window-enabled =
    .label = Opne eksterne lenkjer i sjølvstendige vindauge
