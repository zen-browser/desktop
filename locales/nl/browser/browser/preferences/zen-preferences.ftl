...
sync-currently-syncing-workspaces = Werkruimtes en tabbladen
sync-engine-workspaces =
    .label = Werkruimtes en tabbladen
    .tooltiptext = Synchroniseer je werkruimtes en tabbladen tussen apparaten
    .accesskey = W
