...
zen-standalone-window-header = Fristående fönster
zen-standalone-window-description = Styr hur länkar som öppnas utanför Zen hanteras.
zen-standalone-window-enabled =
    .label = Öppna externa länkar i fristående fönster
