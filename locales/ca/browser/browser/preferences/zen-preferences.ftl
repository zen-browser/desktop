...
zen-layout-single-toolbar = Només la barra lateral
zen-layout-multiple-toolbar = Barra lateral i barra d'eines superior
zen-layout-collapsed-toolbar = Barra lateral col·lapsada
