...
zen-standalone-window-header = Отдельные окна
zen-standalone-window-description = Управление обработкой ссылок, открытых за пределами Zen.
zen-standalone-window-enabled =
    .label = Открывать внешние ссылки в отдельных окнах
