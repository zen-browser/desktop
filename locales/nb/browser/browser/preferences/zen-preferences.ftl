...
sync-currently-syncing-workspaces = Arbeidsområder og faner
sync-engine-workspaces =
    .label = Arbeidsområder og faner
    .tooltiptext = Synkroniser arbeidsområdene og fanene dine på tvers av enheter
    .accesskey = W
