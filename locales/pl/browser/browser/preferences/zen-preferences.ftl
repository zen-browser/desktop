...
zen-theme-marketplace-header = Modyfikacje Astra
...
pane-zen-marketplace-title = Modyfikacje Astra
...
zen-urlbar-title = Pasek adresu Astra
...
zenCKSOption-group-zen-other = Inne funkcje Astra
...
zen-toggle-sidebar-shortcut = Przełącz pasek boczny Astra
