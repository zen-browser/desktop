...
zen-standalone-window-header = Erilliset ikkunat
zen-standalone-window-description = Hallitse sitä, miten Zenin ulkopuolelta avatut linkit käsitellään.
zen-standalone-window-enabled =
    .label = Avaa ulkoiset linkit erillisissä ikkunoissa
