...
zen-theme-marketplace-header = Bản mod Astra
...
zen-urlbar-title = Thanh địa chỉ Astra
...
zenCKSOption-group-zen-other = Các tính năng khác của Astra
...
zen-toggle-sidebar-shortcut = Bật/Tắt thanh bên Astra
