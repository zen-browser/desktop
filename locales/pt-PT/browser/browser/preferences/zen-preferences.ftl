...
zen-standalone-window-header = Janelas autónomas
zen-standalone-window-description = Controlar a forma como são tratados os links abertos fora do Zen.
zen-standalone-window-enabled =
    .label = Abrir links externos em janelas autónomas
