...
zen-standalone-window-header = Samostalni prozori
zen-standalone-window-description = Kontrolišite kako se obrađuju veze otvorene izvan Zena.
zen-standalone-window-enabled =
    .label = Otvori vanjske veze u samostalnim prozorima
