...
zen-key-conflict = Конфликтует с { $group } -> { $shortcut }
...
zen-theme-marketplace-header = Моды для Astra
...
pane-zen-marketplace-title = Моды для Astra
...
zen-urlbar-title = Поле адреса Astra
...
zenCKSOption-group-zen-other = Другие функции Astra
...
zen-toggle-sidebar-shortcut = Переключить боковую панель Astra
