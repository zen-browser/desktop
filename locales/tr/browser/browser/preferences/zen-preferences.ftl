...
zen-tabs-close-on-back-with-no-history = 
    .label = Geçmiş olmadan geri dönüldüğünde sekmeyi kapat ve üst sekmesine (ya da en son kullanılan sekmeye) geç
zen-tabs-cycle-by-attribute = 
    .label = Ctrl+Tab yalnızca Essential veya Workspace sekmeleri arasında geçiş yapar.
