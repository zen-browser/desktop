...
zen-look-and-feel-compact-toolbar-themed = 
    .label = Sử dụng màu chủ đạo cho thanh công cụ tích hợp
zen-workspace-continue-where-left-off = 
    .label = Tiếp tục từ lần mở trước
pane-zen-pinned-tab-manager-title = Ghim thẻ
zen-pinned-tab-manager-header = Thiết lập dùng cho các thẻ đã ghim
zen-pinned-tab-manager-description = Quản lý thêm hành vi của  các thẻ đã ghim
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = Khôi phục thẻ đã ghim về đường dẫn gốc khi khởi động trình duyệt
zen-pinned-tab-manager-container-specific-essentials-enabled = 
    .label = Bật các thẻ chính riêng cho Container
...
zen-toggle-pin-tab-shortcut = Bật Ghim thẻ
...
zen-glance-expand = Mở rộng vùng xem trước
...
zen-new-empty-split-view-shortcut = Tạo vùng chia đôi mới
...
zen-close-all-unpinned-tabs-shortcut = Đóng tất cả các thẻ đã ghim
