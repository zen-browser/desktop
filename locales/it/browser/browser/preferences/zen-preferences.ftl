...
zen-standalone-window-header = Finestre autonome
zen-standalone-window-description = Controlla la gestione dei link aperti dall’esterno di Zen.
zen-standalone-window-enabled =
    .label = Apri i link esterni in finestre autonome
