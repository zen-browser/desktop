...
zen-theme-marketplace-header = Astra-temaer
...
zen-urlbar-title = Astra URL-linje
...
zenCKSOption-group-zen-other = Andre Astra-funktioner
...
zen-toggle-sidebar-shortcut = Slå Astra-sidepanel til/fra
