...
zen-standalone-window-header = חלונות עצמאיים
zen-standalone-window-description = שליטה באופן הטיפול בקישורים שנפתחים מחוץ ל‑Zen.
zen-standalone-window-enabled =
    .label = פתיחת קישורים חיצוניים בחלונות עצמאיים
