...
zen-look-and-feel-window-drag-header = Arrasto de janela
zen-look-and-feel-window-drag-description = Mover a janela ao arrastar espaço vazio no topo de websites, assim como na barra de título.
zen-window-drag-enabled = 
    .label = Permitir arrastar a janela a partir de páginas web
...
zen-workspace-shortcut-create = Criar novo Espaço de Trabalho
...
zen-key-find-selection = Localizar Seleção
