...
zen-layout-single-toolbar = Только боковая панель
zen-layout-multiple-toolbar = Боковая панель и панель инструментов
zen-layout-collapsed-toolbar = Сжатая боковая панель
