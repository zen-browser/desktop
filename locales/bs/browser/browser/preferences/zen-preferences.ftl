...
sync-currently-syncing-workspaces = Radni prostori i kartice
sync-engine-workspaces =
    .label = Radni prostori i kartice
    .tooltiptext = Sinkronizirajte radne prostore i kartice između uređaja
    .accesskey = W
