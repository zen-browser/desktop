...
zen-look-and-feel-window-drag-header = Перетягування вікна
zen-look-and-feel-window-drag-description = Переміщуйте вікно, перетягуючи порожнє місце у верхній частині вебсайтів, так само, як за рядок заголовка.
zen-window-drag-enabled = 
    .label = Дозволити перетягування вікна з вебсторінок
...
zen-search-find-again-shortcut-alt = Знайти знову (Alt)
zen-search-find-again-shortcut-prev-alt = Знайти попереднє (Alt)
