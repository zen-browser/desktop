...
sync-currently-syncing-workspaces = Obszary robocze i karty
sync-engine-workspaces =
    .label = Obszary robocze i karty
    .tooltiptext = Synchronizuj swoje obszary robocze i karty pomiędzy urządzeniami
    .accesskey = Pr
