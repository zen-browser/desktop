...
zen-standalone-window-header = Αυτόνομα παράθυρα
zen-standalone-window-description = Ελέγξτε τον τρόπο διαχείρισης των συνδέσμων που ανοίγουν εκτός του Zen.
zen-standalone-window-enabled =
    .label = Άνοιγμα εξωτερικών συνδέσμων σε αυτόνομα παράθυρα
