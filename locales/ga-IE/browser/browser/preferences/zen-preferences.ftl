...
zen-theme-marketplace-header = Modhanna Astra
...
pane-zen-marketplace-title = Modhanna Astra
...
zen-urlbar-title = Barra URL Astra
...
zenCKSOption-group-zen-other = Gnéithe Astra Eile
...
zen-toggle-sidebar-shortcut = Scoránaigh an Taobhbharra Astra
