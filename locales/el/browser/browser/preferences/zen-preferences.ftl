...
sync-currently-syncing-workspaces = Χώροι εργασίας και καρτέλες
sync-engine-workspaces =
    .label = Χώροι εργασίας και καρτέλες
    .tooltiptext = Συγχρονισμός των χώρων εργασίας και των καρτελών σας σε όλες τις συσκευές
    .accesskey = W
