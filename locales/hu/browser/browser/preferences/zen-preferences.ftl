...
sync-currently-syncing-workspaces = Munkakörnyezetek és lapok
sync-engine-workspaces =
    .label = Munkakörnyezetek és lapok
    .tooltiptext = Munkakörnyezetek és lapok szinkronizálása eszközök között
    .accesskey = W
