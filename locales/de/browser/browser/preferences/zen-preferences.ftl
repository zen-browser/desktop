...
zen-urlbar-title = Astra-Adressleiste
...
zenCKSOption-group-zen-workspace = Astra-Arbeitsbereiche
zenCKSOption-group-zen-other = Andere Astra-Funktionen
...
zen-toggle-sidebar-shortcut = Astra-Seitenleiste umschalten
