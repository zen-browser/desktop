...
zen-settings-workspaces-sync = 
    .label = Kenar çubuğunuzu cihazlar arasında eşitleyin
    .description = Mozilla hesabınız aracılığıyla çalışma alanlarınızı, sabitlenmiş sekmelerinizi ve klasörlerinizi tüm cihazlarınızda eşitlenmiş halde tutun.
