...
sync-currently-syncing-workspaces = Spazi di lavoro e schede
sync-engine-workspaces =
    .label = Spazi di lavoro e schede
    .tooltiptext = Sincronizza gli spazi di lavoro e le schede tra i dispositivi
    .accesskey = W
