...
zen-standalone-window-header = Ferestre independente
zen-standalone-window-description = Controlează modul în care sunt gestionate linkurile deschise din afara Zen.
zen-standalone-window-enabled =
    .label = Deschide linkurile externe în ferestre independente
